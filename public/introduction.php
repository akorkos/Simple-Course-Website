...
<html lang="el">
    ...
    <body>
        <nav class="sidebar">
            <a class="active" href="#"><i class="fas fa-home"></i> Αρχική σελίδα</a>
        ...
        <main>
            <div class="main-text">
                <h1>Αρχική σελίδα</h1>
                <p>
                    Καλώς ήρθατε στην ιστοσελίδα του μαθήματος "Προγραμματισμός Υπολογιστών" του Τμήματος Πληροφορικής 
                    του Αριστοτέλειου Πανεπιστημίου Θεσσαλονίκης.
                </p>
                <p>
                    Στην ιστοσελίδα αυτή θα βρείτε όλες τις ανακοινώσεις του μαθήματος, τα έγγραφα του μαθήματος, 
                    τις εργασίες που έχουν ανατεθεί και τα αποτελέσματα των εργασιών.
                </p>
                <p>
                    Επίσης, μπορείτε να επικοινωνήσετε με τον διδάσκοντα του μαθήματος μέσω της ιστοσελίδας.
                </p>
            </div>

            <div class="image">
                <img src="../images/auth_logo.png" alt="Aristotle University of Thessaloniki logo"/>
            </div>
        </main>
    </body>
</html>