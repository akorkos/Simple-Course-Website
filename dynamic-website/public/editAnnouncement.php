<?php
    ...
    if($_SERVER["REQUEST_METHOD"] === "POST"){
        ...
        $stmt = $db->prepare(
            "UPDATE announcements SET subject = ?, text = ? WHERE id = ?"
        );
                    ...
                    echo'
                        <p>
                            ...
                            <input id="subject" type="text" placeholder="Θέμα" 
                                value=\''.$query[0].'\' name="subject" required>
                        </p>
                        <p>
                            Κείμενο: <br>
                            <textarea id="main" name="main" rows="4" cols="50" 
                                placeholder="Πληροφορίες" required>'.$query[1].'
                            </textarea>
                        </p>
                    ';
                ?>
