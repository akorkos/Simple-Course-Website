<?php
    ...
    if($_SERVER["REQUEST_METHOD"] === "POST"){
        ...
        $sql = "INSERT INTO homeworks (targets, file_name, files_needed, deadline) VALUES (?, ?, ? ,?)";
        ...
        $mainText = "Η ".$number."η εργασία έχει ανακοινωθεί στην ιστοσελίδα<a href='./homework.php'>«Εργασίες»</a>.";
            ...
            <form method="post">
                ...
                <p>
                    ...
                    <textarea id="targets" name="targets" rows="5" cols="50" required
                        placeholder="<αριθμός>. <περιγραφή στόχου> ..."></textarea><br>
                </p>
                <p>
                    Αρχείo εκφώνησης:
                ...
                <p>
                    Παραδοτέα: <br>
                    <textarea id="filesNeeded" name="filesNeeded" rows="5" cols="50"
                        placeholder="<αριθμός>. <όνομα παραδοτέου> ..." required></textarea>
                </p>
                <p>
                    Ημερομηνία:
